...
/* ----------------- SUGGESTED NEW UNITS (Bohairic-focused) -----------------
   These units are appended as examples/skeletons. Each unit contains sample lessons/exercises.
   Adjust IDs, titles, and content to fit your app's schema.
------------------------------------------------------------------------- */

export const suggestedUnits = [
  {
    id: "unit-16-pronunciation",
    title: "Pronunciation & Phonology (Bohairic)",
    description: "Letter sounds, vowel length, common clusters, Greco-Bohairic vs Old Bohairic notes.",
    lessons: [
      {
        id: "u16-lesson-1-alphabet-review", 
        title: "Alphabet review — Bohairic values",
        exercises: [
          { type: "match", prompt: "Match the letter to its Bohairic sound (approx.)", items: [
            { prompt: "Ⲃ", answer: "v (syllable-initial) / b (final)" },
            { prompt: "Ⲅ", answer: "g (before close vowels) / ɣ (before open vowels)" },
            { prompt: "Ⲇ", answer: "ð (like th in 'this') or d in Hebrew names" }
          ]}
        ]
      },
      {
        id: "u16-lesson-2-vowels-diphthongs",
        title: "Vowels & diphthongs",
        exercises: [
          { type: "mcq", prompt: "Which Bohairic vowel pair often merges in Greco-Bohairic pronunciation?", choices: ["i and u", "e and a", "o and u"], answer: 0 }
        ]
      }
    ]
  },
  {
    id: "unit-17-basic-grammar-i",
    title: "Basic Grammar I — Nouns & Articles",
    description: "Gender, singular/plural, the definite article, and simple possession.",
    lessons: [
      {
        id: "u17-lesson-1-article-intro",
        title: "The definite article (ⲡ-, ⲛ-, ⲧ-)",
        exercises: [
          { type: "translate", prompt: "Translate to English: ⲡⲉ ⲛⲓⲕⲟⲩⲣ", answer: "the house" }
        ]
      },
      {
        id: "u17-lesson-2-plurals",
        title: "Plural formation (regular patterns)",
        exercises: [
          { type: "match", prompt: "Match singular to plural", items: [
            { prompt: "ⲡⲉⲣⲉ", answer: "ⲡⲉⲣⲉⲥ" }
          ]}
        ]
      }
    ]
  ...
  {
    id: "unit-18-basic-grammar-ii",
    title: "Basic Grammar II — Pronouns & Prepositions",
    description: "Personal pronouns, enclitic possessives, and common prepositions.",
    lessons: [
      {
        id: "u18-lesson-1-pronouns",
        title: "Personal pronouns",
        exercises: [
          { type: "mcq", prompt: "What does 'ⲁⲛⲟⲕ' mean?", choices: ["I", "You (sg.)", "He/She"], answer: 0 }
        ]
      },
      {
        id: "u18-lesson-2-prepositions",
        title: "Common prepositions",
        exercises: [
          { type: "translate", prompt: "Translate: ⲛⲉⲛ ⲡⲉⲧⲣⲟ", answer: "in the city" }
        ]
      }
    ]
  },
  {
    id: "unit-19-verbs-i",
    title: "Verbs I — Present & Imperative",
    description: "Present-tense forms, basic conjugation patterns, and imperative forms.",
    lessons: [
      {
        id: "u19-lesson-1-present-forms",
        title: "Present tense basics",
        exercises: [
          { type: "fill", prompt: "Give the present 3sg form of 'to speak' (ⲥⲁ-...)", answer: "ⲥⲁⲧⲉ" }
        ]
      },
      {
        id: "u19-lesson-2-imperatives",
        title: "Imperative forms and polite commands",
        exercises: [
          { type: "translate", prompt: "Translate: ⲥⲟⲩⲣⲉ!", answer: "Listen!" }
        ]
      }
    ]
  },
  {
    id: "unit-20-verbs-ii",
    title: "Verbs II — Past & Aspect",
    description: "Past tense, stative forms, and common irregular verbs.",
    lessons: [
      {
        id: "u20-lesson-1-past",
        title: "Past/perfect forms",
        exercises: [
          { type: "mcq", prompt: "Which prefix often marks past in Bohairic?", choices: ["ⲡⲉ-", "ⲛⲉ-", "ⲟⲩ-"], answer: 2 }
        ]
      }
    ]
  },
  {
    id: "unit-21-conversational",
    title: "Conversational Coptic",
    description: "Greetings, introductions, asking questions, polite expressions.",
    lessons: [
      {
        id: "u21-lesson-1-greetings",
        title: "Greetings & basic phrases",
        exercises: [
          { type: "translate", prompt: "Translate: ⲛⲓϫⲉ 'ⲁϥⲉ'", answer: "Good morning (lit. may peace be with you)" }
        ]
      }
    ]
  },
  {
    id: "unit-22-liturgical",
    title: "Liturgical Phrases & Prayers",
    description: "Short prayers, Lord's Prayer, common service phrases.",
    lessons: [
      {
        id: "u22-lesson-1-lords-prayer-intro",
        title: "Lord's Prayer — short phrases",
        exercises: [
          { type: "match", prompt: "Match Coptic phrase to English meaning", items: [
            { prompt: "Ⲡⲁⲧⲉⲣ ⲛ̄ⲡⲉⲓ", answer: "Our Father" }
          ]}
        ]
      }
    ]
  },
  {
    ...
    description: "Short Gospel excerpts with translations and comprehension questions.",
    lessons: [
      {
        id: "u23-lesson-1-gospel-excerpt",
        title: "John 1:1 (short excerpt)",
        exercises: [
          { type: "translate", prompt: "Translate: ϩⲉⲛ ⲁⲛⲟⲥ ⲛ̄ⲧⲉ Ⲡⲁⲧⲉⲣ", answer: "In the beginning was the Father" }
        ]
      }
    ]
  },
  {
    id: "unit-24-orthographic-variants",
    title: "Orthographic Variants — Bohairic vs Sahidic",
    description: "Differences in spelling and usage across dialects; useful for reading manuscripts.",
    lessons: [
      {
        id: "u24-lesson-1-variant-examples",
        title: "Common Bohairic vs Sahidic variants",
        exercises: [
          { type: "match", prompt: "Match Bohairic to Sahidic form", items: [
            { prompt: "Bohairic ⲁⲓ", answer: "Sahidic ⲉ" }
          ]}
        ]
      }
    ]
  },
  {
    ...
    description: "Spaced-repetition reviews and cumulative quizzes for core vocabulary and grammar.",
    lessons: [
      {
        id: "u25-lesson-1-srs-review",
        title: "High-frequency vocabulary review",
        exercises: [
          { type: "srs", prompt: "Review session (20 items)", items: [] }
        ]
      }
    ]
  }
...
// End of appended suggested units




/* ----------------- SUGGESTED NEW UNITS (FLESHED, Bohairic-focused) ----------------- */

export const suggestedUnitsExpanded = [
  {
    id: "unit-16-pronunciation",
    title: "Pronunciation & Phonology (Bohairic)",
    description: "Letter sounds, vowel length, common clusters, Greco-Bohairic vs Old Bohairic notes.",
    lessons: [
      {
        id: "u16-1-alphabet-review",
        title: "Alphabet review — Bohairic values",
        exercises: [
          { type: "match", prompt: "Match the letter to its Bohairic approximation (audio recommended)", items: [
            { prompt: "Ⲃ", answer: "v (initial) / b (final). e.g., Ⲃⲁⲃⲉ 'babe' (child)" },
            { prompt: "Ⲅ", answer: "g (before front vowels) / ɣ elsewhere. e.g., Ⲅⲁⲣ 'gar' (word)" },
            { prompt: "Ⲇ", answer: "ð (like 'this'). e.g., Ⲇⲱ 'this' (demonstrative)" }
          ]}
        ]
      },
      {
        id: "u16-2-vowels-diphthongs",
        title: "Vowels & diphthongs",
        exercises: [
          { type: "mcq", prompt: "Which Bohairic vowel pair often merges in Greco-Bohairic pronunciation?", choices: ["i and u", "e and a", "o and u"], answer: 0 },
          { type: "translate", prompt: "Transliterate: ⲁⲓⲟ", answer: "aio (ai-o) — vowel sequence" }
        ]
      },
      {
        id: "u16-3-clusters",
        title: "Consonant clusters & Aspiration",
        exercises: [
          { type: "fill", prompt: "Give a Bohairic example with ⲑ (th) cluster: ⲑ___", answer: "ⲑⲁⲩ (thau) — example (hypothetical)" }
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "u17-1-article-intro",
        title: "The definite article (ⲡ-, ⲛ-, ⲧ-)",
        exercises: [
          { type: "translate", prompt: "Translate to English: ⲡⲉ ⲛⲓⲕⲟⲩⲣ", answer: "the house" },
          { type: "mcq", prompt: "Which article marks feminine singular?", choices: ["ⲡ-", "ⲧ-", "ⲛ-"], answer: 1 }
        ]
      },
      {
        id: "u17-2-plurals",
        ...
        exercises: [
          { type: "match", prompt: "Match singular to plural", items: [
            { prompt: "ⲡⲉⲣⲉ", answer: "ⲡⲉⲣⲉⲥ" },
            { prompt: "ⲧⲁⲡ", answer: "ⲧⲁⲡⲉ" }
          ]}
        ]
      },
      {
        id: "u17-3-possession",
        title: "Possessive constructions",
        exercises: [
          { type: "translate", prompt: "Translate: ⲡⲉ ⲡⲁⲧⲉⲣ ⲛ̄ⲙⲉ", answer: "the father of me / my father" }
        ]
      }
    ]
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          { type: "mcq", prompt: "What does 'ⲁⲛⲟⲕ' mean?", choices: ["I", "You (sg.)", "He/She"], answer: 0 },
          { type: "fill", prompt: "Provide the 2nd sg pronoun", answer: "ⲁⲛⲟⲕ" }
        ]
      },
      {
        id: "u18-2-prepositions",
        title: "Common prepositions",
        exercises: [
          { type: "translate", prompt: "Translate: ⲛⲉⲛ ⲡⲉⲧⲣⲟ", answer: "in the city" },
          { type: "match", prompt: "Match preposition to meaning", items: [
            { prompt: "ⲛⲉⲛ", answer: "in" },
            { prompt: "ⲙⲉ", answer: "with / by" }
          ]}
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "u19-1-present-forms",
        title: "Present tense basics",
        exercises: [
          { type: "fill", prompt: "Give the present 3sg form of 'to speak' (ⲥⲁ-...)", answer: "ⲥⲁⲧⲉ" },
          { type: "translate", prompt: "Translate: ⲥⲁⲧⲉ ⲁⲛⲟⲕ", answer: "I speak / I am speaking" }
        ]
      },
      {
        id: "u19-2-imperatives",
        title: "Imperative forms and polite commands",
        exercises: [
          { type: "translate", prompt: "Translate: ⲥⲟⲩⲣⲉ!", answer: "Listen!" },
          { type: "mcq", prompt: "Which ending marks a polite request?", choices: ["-ⲉ", "-ⲟ", "-ⲛ"], answer: 0 }
        ]
      }
    ]
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          { type: "mcq", prompt: "Which prefix often marks past in Bohairic?", choices: ["ⲡⲉ-", "ⲛⲉ-", "ⲟⲩ-"], answer: 2 },
          { type: "translate", prompt: "Translate: ⲟⲩⲣⲉ ⲁⲛⲟⲕ", answer: "I saw" }
        ]
      }
    ]
  },
    ...
    lessons: [
      {
        ...
        title: "Greetings & basic phrases",
        exercises: [
          { type: "translate", prompt: "Translate: ⲛⲓϫⲉ ⲁϥⲉ", answer: "Good morning / Peace be with you" },
          { type: "mcq", prompt: "How do you say 'thank you' (Bohairic tradition)?", choices: ["ⲥⲁⲛϩⲱ", "ⲥⲉⲣⲉ", "ⲡⲁϩ"], answer: 0 }
        ]
      },
      {
        id: "u21-2-introductions",
        title: "Introducing yourself",
        exercises: [
          { type: "translate", prompt: "Translate: ⲁⲛⲟⲕ ⲙ̄ⲡⲉⲣ", answer: "I am Peter" }
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "u22-1-lords-prayer-intro",
        title: "Lord's Prayer — short phrases",
        exercises: [
          { type: "match", prompt: "Match Coptic phrase to English meaning", items: [
            { prompt: "Ⲡⲁⲧⲉⲣ ⲛ̄ⲡⲉⲓ", answer: "Our Father" },
            { prompt: "Ⲡⲁⲧⲉⲣ ⲛ̄ⲡⲉⲓ ϩⲉⲛ ⲟⲩⲣⲁⲛⲟⲥ", answer: "Our Father who art in heaven" }
          ]}
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "u23-1-gospel-excerpt",
        title: "John 1:1 (short excerpt)",
        exercises: [
          { type: "translate", prompt: "Translate: ϩⲉⲛ ⲡⲁⲧⲉⲣ ⲛ̄ⲧⲉ ⲡⲉ", answer: "In the beginning was the Word" },
          { type: "mcq", prompt: "Who is 'ⲡⲁⲧⲉⲣ' in this context?", choices: ["the Word", "the Father", "the Light"], answer: 1 }
        ]
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "u24-1-variant-examples",
        title: "Common Bohairic vs Sahidic variants",
        exercises: [
          { type: "match", prompt: "Match Bohairic to Sahidic form", items: [
            { prompt: "Bohairic ⲁⲓ", answer: "Sahidic ⲉ" },
            { prompt: "Bohairic ⲡⲁⲧⲉⲣ", answer: "Sahidic ⲡⲁⲧⲉⲣ (often identical)" }
          ]}
        ]
      }
    ]
...
// End of appended fleshed suggested units
